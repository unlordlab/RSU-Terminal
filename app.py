...
# CSS DE EMERGENCIA: Resetear completamente el sidebar para evitar movimientos
st.markdown("""
<style>
    /* FORZAR reset completo del sidebar */
    [data-testid="stSidebar"] {
    ...
    /* Resetear TODOS los elementos del sidebar */
    [data-testid="stSidebar"] * {
        transform: none !important;
    ...
    /* Permitir solo animaciones específicas controladas */
    [data-testid="stSidebar"] .live-dot {
    ...
    /* Asegurar que el menú no se mueva */
    [data-testid="stSidebar"] .stRadio > div[role="radiogroup"] > label {
        transform: none !important;
