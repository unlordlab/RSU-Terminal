...
with st.sidebar:
    ...
    # ... (Se mantiene todo tu código original del gráfico de la aguja y la leyenda)
    ...
    # Lógica de estados del Fear & Greed
...
if menu == "📊 DASHBOARD":
    ...
    rsu_algoritmo.render() # Aquí es donde ahora se mostrará el semáforo
elif menu == "🤖 IA REPORT":
    ia_report.render()
elif menu == "💼 CARTERA":
    cartera.render()
