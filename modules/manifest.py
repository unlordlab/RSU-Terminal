...
def render():
    # CSS Global - todo en un bloque limpio
    st.markdown("""
<style>
...
.divider {
    ...
    # WARNING BOX
    st.markdown("""
    <div style="background: linear-gradient(135deg, #1a0f0f 0%, #261a1a 100%); border: 1px solid #f23645; border-radius: 8px; padding: 20px; margin: 20px 0;">
        <h4 style="color: #f23645; margin: 0 0 10px 0; font-family: 'Fira Code', monospace; text-transform: uppercase; letter-spacing: 1px;">⚠️ ADVERTENCIA DE SEGURIDAD</h4>
    ...
    # SECCIÓN 0
    st.markdown('<div class="section-header">0. LA LENTA CANCELACIÓN DEL FUTURO</div>', unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class="quote-box">
        <p style="margin: 0 0 0 30px;">Claro que hay una guerra de clases, y es mi clase, la de los ricos, la que la está haciendo, y la estamos ganando.</p>
    ...
    <div style="background: #0c0e12; border: 1px solid #00ffad; border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center;">
        <span style="color: #00ffad; font-family: 'Fira Code', monospace; font-size: 1.3rem; font-weight: bold;">RSU nace para dejar de perder.</span>
    </div>
    """, unsafe_allow_html=True)

    # SECCIÓN 1
    st.markdown('<div class="divider">▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬</div>', unsafe_allow_html=True)
    st.markdown('<div class="section-header">1. EL MERCADO COMO CAMPO DE BATALLA (Y EXPLOIT)</div>', unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div style="background: #1a1e26; border: 1px solid #f23645; border-radius: 8px; padding: 20px; height: 100%;">
            <h4 style="color: #f23645; font-family: 'Fira Code', monospace; margin-top: 0;">⚡ VULNERABILIDAD DETECTADA</h4>
            <p style="color: #ccc; font-size: 0.9rem;">Sin embargo, el mercado posee una vulnerabilidad: <span class="highlight-green">su propia infraestructura</span>.</p>
            <br>
    ...
    # METODOLOGÍA RSU
    st.markdown("""
    <div style="background: linear-gradient(135deg, #0c0e12 0%, #1a1e26 100%); border: 1px solid #00ffad; border-radius: 10px; padding: 25px; margin: 30px 0;">
        <h3 style="color: #00ffad; font-family: 'Fira Code', monospace; margin-top: 0;">&gt; LA METODOLOGÍA RSU</h3>
    ...
    # SECCIÓN 2
    st.markdown('<div class="divider">▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬</div>', unsafe_allow_html=True)
    st.markdown('<div class="section-header">2. MERITOCRACIA RADICAL VS. PRECARIEDAD</div>', unsafe_allow_html=True)

    # MUNDO EXTERIOR vs TERMINAL RSU
    st.markdown("""
    <div style="background: #1a1e26; border: 1px solid #f23645; border-radius: 8px; padding: 20px; margin-bottom: 10px;">
        <h4 style="color: #f23645; font-family: 'Fira Code', monospace; margin-top: 0;">🌍 MUNDO EXTERIOR</h4>
        <p style="color: #aaa; margin: 0;">Tu género, tu raza y tu código postal predeterminan tu techo de cristal. El neoliberalismo privatiza tu malestar y te culpa de tu pobreza.</p>
    </div>
    """, unsafe_allow_html=True)

    st.markdown('<div style="text-align: center; color: #00ffad; font-size: 2rem; margin: 10px 0;">⇅</div>', unsafe_allow_html=True)

    st.markdown("""
    <div style="background: #0c0e12; border: 1px solid #00ffad; border-radius: 8px; padding: 20px; box-shadow: 0 0 20px rgba(0, 255, 173, 0.1); margin-bottom: 20px;">
        <h4 style="color: #00ffad; font-family: 'Fira Code', monospace; margin-top: 0;">💻 TERMINAL RSU</h4>
        <p style="color: #ccc; margin: 0;">El gráfico no sabe quién eres. El mercado es un entorno hostil, sí, pero es uno de los pocos lugares donde <span class="highlight-green">el conocimiento técnico y la disciplina pueden superar a la herencia</span>.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div style="background: #1a1e26; border-radius: 8px; padding: 20px; height: 100%; border-top: 3px solid #00d9ff;">
            <h4 style="color: #00d9ff; font-family: 'Fira Code', monospace; font-size: 0.9rem; margin-top: 0;">🧠 DESPRIVATIZAR LA SALUD MENTAL</h4>
            <p style="color: #aaa; font-size: 0.9rem; line-height: 1.6;">Operar no es una terapia, pero la <span class="highlight-green">libertad financiera</span> es la única cura real para la ansiedad estructural de la precariedad.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div style="background: #1a1e26; border-radius: 8px; padding: 20px; height: 100%; border-top: 3px solid #ff9800;">
            <h4 style="color: #ff9800; font-family: 'Fira Code', monospace; font-size: 0.9rem; margin-top: 0;">⚔️ CONSCIENCIA DE CLASE</h4>
            <p style="color: #aaa; font-size: 0.9rem; line-height: 1.6;">Operamos con los ricos, pero no somos como ellos. No buscamos la explotación del prójimo, sino la <span class="highlight-orange">extracción de liquidez</span> de un sistema amañado que lleva décadas robándonos el futuro.</p>
        </div>
        """, unsafe_allow_html=True)

    # SECCIÓN 3
    st.markdown('<div class="divider">▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬</div>', unsafe_allow_html=True)
    st.markdown('<div class="section-header">3. EL CÓDIGO DE RSU</div>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div style="margin-bottom: 20px;">
            <h4 style="color: #00ffad; font-family: 'Fira Code', monospace; font-size: 0.9rem; margin-bottom: 10px;">01. SEGUIR EL RASTRO</h4>
            <p style="color: #888; font-size: 0.85rem; margin: 0;">Donde hay manipulación, hay oportunidad. No operamos contra el mercado, operamos contra <span style="color: #f23645;">la ilusión que el mercado crea para las masas</span>.</p>
        </div>
        <div style="margin-bottom: 20px;">
            <h4 style="color: #00d9ff; font-family: 'Fira Code', monospace; font-size: 0.9rem; margin-bottom: 10px;">02. SOLIDARIDAD TÉCNICA</h4>
            <p style="color: #888; font-size: 0.85rem; margin: 0;">El conocimiento bursátil ha sido propiedad exclusiva de las clases dominantes. RSU democratiza el acceso a la <span style="color: #00ffad;">"caja negra"</span> del trading profesional.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div style="margin-bottom: 20px;">
            <h4 style="color: #ff9800; font-family: 'Fira Code', monospace; font-size: 0.9rem; margin-bottom: 10px;">03. REALISMO OPERATIVO</h4>
            <p style="color: #888; font-size: 0.85rem; margin: 0;">Aceptamos que el capitalismo es una estructura impersonal y abstracta. Para destruirla o escapar de ella, primero debemos <span style="color: #ff9800;">dominar su lenguaje</span>: el precio y el tiempo.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div style="background: linear-gradient(135deg, #0c0e12 0%, #1a1e26 50%, #0c0e12 100%); border: 2px solid #00ffad; border-radius: 15px; padding: 40px; margin: 40px 0; text-align: center;">
        <div style="height: 3px; background: linear-gradient(90deg, #f23645, #ff9800, #00ffad, #00d9ff, #f23645); margin-bottom: 30px;"></div>
        
        <h2 style="color: #00ffad; font-family: 'Fira Code', monospace; font-size: 1.5rem; margin-bottom: 30px; text-transform: uppercase; letter-spacing: 3px;">Conclusión: Hackea el Deseo, Reclama el Tiempo</h2>
        ...
        <div style="background: #0c0e12; border-left: 3px solid #f23645; border-right: 3px solid #f23645; padding: 20px; margin: 30px 0; display: inline-block;">
        ...
        <div style="margin-top: 40px; padding-top: 30px; border-top: 1px solid #1a1e26;">
            <p style="color: #00ffad; font-family: 'Fira Code', monospace; font-size: 1.3rem; font-weight: bold; letter-spacing: 5px; margin: 0;">BIENVENIDOS A RSU</p>
            <p style="color: #f23645; font-family: 'Fira Code', monospace; font-size: 0.9rem; margin-top: 10px; text-transform: uppercase;">El exploit ha comenzado<span class="cursor"></span></p>
        </div>
        
        <div style="height: 3px; background: linear-gradient(90deg, #f23645, #ff9800, #00ffad, #00d9ff, #f23645); margin-top: 30px;"></div>
    </div>
    """, unsafe_allow_html=True)
